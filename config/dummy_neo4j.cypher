...
MERGE (a:Node {Text: "Peach"})
MATCH (a:Node {Text:"Fruit"}) MATCH (b:Node {Text: "Peach"}) MERGE (a) - [:Associated] - (b)
MATCH (a:Node {Text:"AVL"}) MATCH (b:Node {Text: "Computer Science"}) MERGE (a) - [:Associated] - (b)
MATCH (a:Node {Text:"Computer Science"}) MATCH (b:Node {Text: "Professor"}) MERGE (a) - [:Associated] - (b)
MATCH (a:Node {Text:"Professor"}) MATCH (b:Node {Text: "Aaron Wilkin"}) MERGE (a) - [:Associated] - (b)
...
MATCH (a:Node {Text:"Tree"}) MATCH (b:Node {Text: "Birch"}) MERGE (a) - [:Associated] - (b)
